...
def objective(trial):
    ...
    gamma = trial.suggest_float('gamma', 0.7, 0.999999)
...
#             start = time.time()
            if task.name == "PRETRAIN-EEG-IMG-CLIP-MATCHING":
...
study = optuna.load_study(study_name="EIM-50", storage="sqlite:///OPTUNA-DB/EIM-50.db")
