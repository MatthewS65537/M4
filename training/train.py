print("[INFO] Starting train.py run.")
import sys
...
eeg_enc = EEGEncoder(txt_in_feat=840, img_in_feat=128, enc_feat=1024, dec_emb_sz=768, enc_nhead=8, enc_dim_ff=2048, num_enc_layers=8, device=device).to(device)
...
torch.save(eeg_enc.state_dict(), "./checkpoints/EEG_ENC_FINAL.pt")
