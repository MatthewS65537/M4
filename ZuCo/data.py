# Taken from "Open Vocabulary Electroencephalography-To-Text Decoding and Zero-shot Sentiment Classification"
import os
import numpy as np
import torch
import pickle
...
# macro
ZUCO_SENTIMENT_LABELS = json.load(open('./data/ZuCo/task1-SR/sentiment_labels.json'))
SST_SENTIMENT_LABELS = json.load(open('./data/ZuCo/stanfordsentiment/ternary_dataset.json'))
...
# max_len 77 from CLIP tokenizer max length
def get_input_sample(sent_obj, tokenizer, eeg_type = 'GD', bands = ['_t1','_t2','_a1','_a2','_b1','_b2','_g1','_g2'], max_len = 77, add_CLS_token = False):
    ...
    if 'emp 1 1 1 1 1 ty' in target_string:
        # print("1", target_string)
        target_string = target_string.replace('emp 1 1 1 1 1 ty','empty')
        # print("2", target_string)
    ...
    # if 'emp11111ty' in target_string or 'emp 1 1 1 1 1 ty' in target_string:
    #     print(target_string)
    # if 'film.1' in target_string or 'film. 1' in target_string:
    #     print(target_string)
